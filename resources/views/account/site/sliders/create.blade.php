...
<div id="admin-pages">
	...
	<h1 class="page-title">{{ Lang::get('account/site.sliders.create.title') }}</h1>

	{!! Form::model(null, [ 'method'=>'POST', 'action'=>'Account\Site\SlidersController@store', 'id'=>'sliders-form' ]) !!}
