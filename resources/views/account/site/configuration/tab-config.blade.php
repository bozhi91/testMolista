...
<div class="row">
	...
	<div class="col-xs-12 col-sm-6">
		<div class="form-group">
			{!! Form::label('hide_Contromia', Lang::get('account/site.configuration.hide.Contromia', [ 'webname'=>env('WHITELABEL_WEBNAME','Contromia') ])) !!}
			<div class="error-container">
				@if ( $current_site->can_hide_Contromia )
					{!! Form::select('hide_Contromia', [
						'1' => Lang::get('general.yes'),
						'0' => Lang::get('general.no'),
					], null, [ 'class'=>'form-control' ]) !!}
				@elseif ( $current_site->hide_Contromia )
					{!! Form::select('hide_Contromia', [
						'1' => Lang::get('general.yes'),
					], null, [ 'class'=>'form-control' ]) !!}
				@else
			...
			@if ( !$current_site->can_hide_Contromia )
				<div class="help-block">{{ Lang::get('account/site.configuration.hide.Contromia.helper') }}</div>
			@endif
		</div>
	</div>
</div>
