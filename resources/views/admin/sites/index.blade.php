						...
						<thead>
							<tr>
								{!! drawSortableHeaders(url()->full(), [
									...
									'properties' => [ 'title' => Lang::get('admin/sites.properties'), 'sortable'=>false, 'class'=>'text-right' ],
									'employees' => [ 'title' => Lang::get('admin/sites.employees'), 'sortable'=>false, 'class'=>'text-right' ],
