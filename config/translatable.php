<?php
    ...
    $custom = \App\Models\Locale::getConfig();

    if ( !empty($custom['adminLocales']) )
    {
        $config['locales'] = $custom['adminLocales'];
    }

    if ( !empty($custom['adminLocalesSelect']) )
    {
        $config['locales_select'] = $custom['adminLocalesSelect'];
    }
    else
    {
        $config['locales_select'] = [];
    }
