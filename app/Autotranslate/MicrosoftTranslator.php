...
if (!defined('MICROSOFT_PRIMARY_ACCOUNT_KEY')) 
{
	define('MICROSOFT_PRIMARY_ACCOUNT_KEY', \Config::get('app.microsoft_primary_account_key'));
}
...
* Demo: http://renjith.co.in/translate/
* 
...
class MicrosoftTranslator
{
	...
	*/
	...
	{
		$this->accountKey = MICROSOFT_PRIMARY_ACCOUNT_KEY;
	...
	*/
	public function translate($from, $to, $text, $format = 'Raw' )
	{
		...
		{
			$this->getErrorResponse('', self::MISSING_ERROR, '');
			return;
		}
