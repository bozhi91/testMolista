...
class UnpublishPropertyApi extends Job implements ShouldQueue {
	...
	public function handle() {
		$result = $this->handler->unpublishProperty($this->property);
		...
		$log->action = 'delete';
		$log->request = $this->handler->getLastRequest();
		$log->result = $result;
		$log->save();
	}
